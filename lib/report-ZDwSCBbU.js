...
.evidence-empty{padding:28px;text-align:center;color:var(--muted)}.modal-actions{display:flex;gap:8px;margin:10px 0 18px;flex-wrap:wrap}.modal-actions a{text-decoration:none}.hidden{display:none!important}.modal-shot{height:auto;min-height:220px;max-height:62vh;background:#090d14;display:grid;place-items:center;overflow:auto}.modal-shot img{display:block;max-width:100%;width:auto;height:auto;max-height:60vh;object-fit:contain}@media(max-width:620px){.xp-modal{padding:10px}.modal-card{padding:16px;max-height:96vh}}
`;
const REPORT_BODY = `
