...
import { r as renderReport } from "./report-Dg1ca3hw.js";
import { a as scoreRun, d as runExperience } from "./experience-s_ksPLT5.js";
...
*/
function runCase(testCase, signal) {
...
async function execute(invocation) {
	...
	const outcomes = [];
	for (const testCase of config.cases) outcomes.push(await runCase(testCase, invocation.signal));
