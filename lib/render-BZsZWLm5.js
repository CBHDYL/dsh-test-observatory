...
<section data-page="summary" class="hero"><div><div class="eyebrow" id="heroEyebrow">Executive quality report · Run #1842</div><h1 id="heroHeadline">Release confidence, without the guesswork.</h1><p class="hero-copy" id="heroSummary">The candidate is measurably healthier than the previous run. Core purchase flows are stable; five isolated regressions remain contained to non-blocking edge cases.</p><p class="xp-note hidden" id="snapshotNote" style="margin-top:10px"></p><div class="verdict"><span class="pulse"></span><span id="heroVerdict">Release Ready</span> <span style="color:var(--muted);font-weight:400" id="heroConfidence">· 92% confidence</span></div><div class="risk" id="heroRiskBox"><b>Risk summary</b> · <span id="heroRisk">Low aggregate risk.</span></div><div style="margin-top:20px"><button class="btn primary" id="reviewFailures">Review 18 failures <svg class="icon" viewBox="0 0 24 24"><path d="m9 18 6-6-6-6"/></svg></button></div></div><div class="score"><div class="gauge-wrap"><svg width="220" height="220" viewBox="0 0 220 220"><defs><linearGradient id="scoreGrad"><stop stop-color="#736cff"/><stop offset="1" stop-color="#1aa8ff"/></linearGradient></defs><circle class="gauge-bg" cx="110" cy="110" r="88"/><circle class="gauge" cx="110" cy="110" r="88"/></svg><div class="score-label"><strong id="heroScore">92</strong><span>QUALITY SCORE</span></div></div></div></section>
