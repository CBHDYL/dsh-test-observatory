	...
	try {
		...
		for (const spec of options.journeys) {
			...
			const capture = async (caption, category, selector) => {
				const result = selector === void 0 ? await captureEvidence(page, [], masks) : await captureElement(page, selector);
			...
			let journey;
			try {
				journey = await runJourney(page, spec, async (caption, category, selector) => capture(caption, category, selector), retries, settleTimeoutMs, (label) => {
...
//#endregion
export { checkAccessibility as _, SLOW_STEP_MS as a, DEFAULT_STEP_TIMEOUT_MS as c, resolveExecutable as d, runExperience as f, findDuplicateEvidence as g, MAX_SHOT_BYTES as h, SCORE_DIMENSIONS as i, DEFAULT_VIEWPORT as l, collectViolations as m, axeGuidance as n, bandFor as o, checkVisual as p, guidanceFor as r, scoreRun as s, experience_exports as t, launchChromium as u };
